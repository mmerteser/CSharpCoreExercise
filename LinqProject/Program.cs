...
namespace LinqProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //JointTest(products, categories);

            Console.ReadKey();
        }

        private static void JointTest(List<Product> products, List<Category> categories)
        {
        ...
        private static void GetProductsWithLinq(List<Product> products)
        {
